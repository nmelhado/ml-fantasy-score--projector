...
def analyze_wrs():
    ...
    with io.open('computed/wr_data.csv', 'w', newline='') as stat_file:
    ...
    df = pandas.read_csv('computed/wr_data.csv', delimiter=",")
    ...
    for label in labels:
        ...
        pickle.dump(regr, open("models/wr_" + label + ".pkl", "wb"))
