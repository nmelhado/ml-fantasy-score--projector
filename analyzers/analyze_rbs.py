...
def analyze_rbs():
    ...
    with io.open('computed/rb_data.csv', 'w', newline='') as stat_file:
    ...
    df = pandas.read_csv('computed/rb_data.csv', delimiter=",")
    ...
    for label in labels:
        ...
        pickle.dump(regr, open("models/rb_" + label + ".pkl", "wb"))
